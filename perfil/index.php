...
<!--Estrellas-->
<form class="form">
	<input class="1" type="radio">
	<label for="1">★</label>

	<input class="2" type="radio">
	<label for="2">★</label>

	<input class="3" type="radio">
	<label for="3">★</label>

	<input class="4" type="radio">
	<label for="4">★</label>
...
<footer>
	<iframe src="../templates/foot/foot.html" class="iframefoot"></iframe>
</footer>
</html>